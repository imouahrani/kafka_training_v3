...
import com.imouahrani.bankTransactionsQueries.model.JsonSerde;
...
public class BankBalanceTopology {
    ...
    public static final String BANK_BALANCES_STORE = "bank-balances_store";
    ...
    public static Topology buildTopology() {
        ...
        KStream<Long, BankBalance> bankBalancesStream = streamsBuilder.stream(BANK_TRANSACTIONS,
                ...
                .with(Serdes.Long(), bankBalanceSerde))
                .toStream();
        bankBalancesStream
